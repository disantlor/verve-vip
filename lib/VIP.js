...
async function completeDraftOrder(draft_order_id) {
    ...
    // TODO: confirm they have card on file!!!
    ...
    try {
        charge = await Stripe.charges.create(charge_params)
    } catch(e) {
        console.error('Failed to charge customer card', charge_params)
    ...
    console.log("Completed order:", completed_order)
